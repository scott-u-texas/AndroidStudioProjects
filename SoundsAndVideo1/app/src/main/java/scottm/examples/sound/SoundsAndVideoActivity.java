...
//        }
    ...
    private void showContent() {
        ...
        if (cursor == null) {
            ...
            Log.d(TAG, audioIDs.size() + "");
            Log.d(TAG, "picked this id at random: " + audioIDs.get(0));
            cursor.close();
        }
    }

    private long pickRandomAudioID() {
        long result = -1;
        if (audioIDs != null) {
            result = audioIDs.get(rand.nextInt(audioIDs.size()));
        }
        return result;
    }
